/**
 * Pure relayer client for the Channels plugin protocol (OpenZeppelin
 * Relayer behind a Caddy /relay route). No environment coupling: callers
 * supply `baseUrl` explicitly — the frontend's `relayerClient.ts` shim adds
