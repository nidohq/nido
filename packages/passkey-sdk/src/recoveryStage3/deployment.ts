//! Canonical testnet deploy of the shared recovery stack. Not
...
//! their own. See DEPLOYED.md's recovery controller/verifier rows for
//! provenance/verification notes (wasm interface checked against
//! `contracts/recovery-controller` and `contracts/recovery-verifier`'s own
//! `stellar contract info interface` output before being recorded here).
