//! Target-document construction + diff for recovery attempts
...
//! before/after structural diff — a simple before/after JSON diff is enough
//! given these target documents are small, flat structures.
