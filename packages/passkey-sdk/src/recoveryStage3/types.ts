//! Friendly input types for the Stage 3 recovery SDK. These are NOT the
//! generated `@nidohq/recovery-controller` bindings' wire types directly
 ...
 *  this experiment (no `reconfigure` entry point) — see the crate's "Known
