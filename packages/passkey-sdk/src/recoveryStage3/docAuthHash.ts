...
//! `compute_doc_auth_hash` — the Stage 3 (`nido-recovery-controller`) twin of
//! `../zkRecovery/authHash.ts::computeAuthHash`. Deliberately a SEPARATE
//! function (not a variant of the M1 one): Stage 3's circuit
 ...
 *  submission's full committed context (`ProposalCommitment`, follow-up.md
 *  §5.3), matching `zk.rs::compute_doc_auth_hash`'s argument list 1:1. */
