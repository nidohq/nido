//! Shared enrollment defaults for the wallet's SIMPLIFIED recovery-enrollment
//! forms (guardian-only via `policyBlocks/multisigRecovery.ts`, ZK-only via the
 ...
 *  TRANSITION_SPEC.md §10 is explicit that NEITHER `Freeze` NOR `Continue`
 *  is spec-mandated as a default. These simplified
...
// Testnet-appropriate ordinary tunables (NOT the deliberately-unresolved
// axis above — TRANSITION_SPEC.md only withholds a default for
