...
/// DOC-ONLY: the account no longer exports `add_multisig_recovery`
...
/// route at all: a real product cost of the doc-only design, to be
/// addressed by the account-recovery work. The read-side
/// (`fromChain`/`summarize`) still renders existing rules.
