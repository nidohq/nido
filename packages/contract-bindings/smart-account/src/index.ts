...
export const NidoSmartAccountError = {
   ...
   * the completion vehicle while a recovery is live-pending. Raised via
   * `panic_with_error!` (not a `Result` return), unlike `apply_doc`'s own
   * errors below — that's why it stays on this plain `#[contracterror]`
   * enum instead of moving to `ApplyDocError`: `soroban-sdk-tools`'s
   * `#[scerr]` composed ("root mode") enums don't implement the
   * `SpecShakingMarker` bound `Env::panic_with_error` requires (only
   * plain `#[contracterror]` enums do), so a type raised via
   * `panic_with_error!` anywhere can't also carry an `#[scerr]`
   * `#[from_contract_client]`/`#[transparent]` variant.
   */
  10: {message:"DocOnlyWritePath"},
  /**
   ...
   * gate.
   */
  11: {message:"RecoveryCompletionNotGranted"},
  /**
   ...
   */
  12: {message:"RecoveryCompletionMismatch"}
}
...
export interface Client {
  ...
  /**
   * Construct and simulate a get_applied_doc transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   ...
   */
  get_applied_doc: (options?: MethodOptions) => Promise<AssembledTransaction<Option<Buffer>>>
   ...
   * raw mutator. Requires this account's own auth,
   ...
   * oppo
   */
  complete_recovery: ({doc_json}: {doc_json: Buffer}, options?: MethodOptions) => Promise<AssembledTransaction<Result<Buffer>>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        ...
        "",
        "",
        ...
        "",
        "",
        ...
        "AAAAAAAAACJSZWFkLW9ubHk6IG9uZSBjb250ZXh0IHJ1bGUgYnkgaWQuAAAAAAAQZ2V0X2NvbnRleHRfcnVsZQAAAAEAAAAAAAAAD2NvbnRleHRfcnVsZV9pZAAAAAAEAAAAAQAAB9AAAAALQ29udGV4dFJ1bGUA",
        ...
        "",
        ...
        "AAAAAAAAAChSZWFkLW9ubHk6IG51bWJlciBvZiBsaXZlIGNvbnRleHQgcnVsZXMuAAAAF2dldF9jb250ZXh0X3J1bGVzX2NvdW50AAAAAAAAAAABAAAABA==",
  ...
  public readonly fromJSON = {
    execute: this.txFromJSON<null>,
        ...
        get_applied_doc: this.txFromJSON<Option<Buffer>>,
        ...
        complete_recovery: this.txFromJSON<Result<Buffer>>,
