...
impl Upgradable for Contract {
    ...
    /// while upgrading the testnet factory to the doc-only smart-account
    /// wasm. A factory upgraded from a build that
...
mod test {
    ...
    /// (found live, upgrading the testnet factory to the doc-only
    /// smart-account wasm).
    #[test]
