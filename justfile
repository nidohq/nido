...
fmt-pkgs := "-p nido-integration-tests -p nido-zk-bench -p nido-smart-account -p nido-zk-recovery -p nido-factory -p nido-multisig-policy -p nido-name-registry -p nido-preauth-sweep-policy -p nido-spending-limit-policy -p nido-status-message -p nido-webauthn-verifier -p nido-zk-verifier -p nido-recovery-doc-completion -p nido-recovery-controller -p nido-recovery-verifier"
