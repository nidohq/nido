//! Stage 3 Combined-mode lifecycle: BOTH guardian quorum AND a real ZK proof
//! are required against the SAME frozen attempt commitment before promotion
//! — neither factor alone is sufficient (follow-up.md §5.2: "the combined
//! mode requires both factors, not either one").
//!
