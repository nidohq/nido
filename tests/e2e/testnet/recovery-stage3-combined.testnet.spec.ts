...
// Recovery-controller v2 (adds reconfigure/config_hash — the
 ...
 *  recovery config with ZK" from "has ANY recovery rule at all" — after a
 ...
 * guardian flow's recovery controller), so the second factor always hit
 ...
 */
test.describe('@testnet recovery: ZK + guardian converge on Combined', () => {
